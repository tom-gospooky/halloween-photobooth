...
* Be direct and hyper efficient.
* Use **performative, iconic cinematic phrasing** (e.g. “Stage them under…,” “Show them framed by…”).
...
* Use 3–6 clipped sentences, always in present tense. Each line = a visible beat of action or camera motion.
...
* Escalation is required — the tension must intensify, but the form is open. Possible escalations include:
